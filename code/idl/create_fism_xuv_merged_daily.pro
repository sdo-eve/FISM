...
pro create_fism_xuv_merged_daily, strt_yr=strt_yr, end_yr=end_yr, update=update, $
  alltags=alltags
...
;version='02_01'
res_pth= expand_path('$fism_results')+'/daily_data/xuv_daily/'
...
if keyword_set(update) then begin
	...
	restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'.sav'
	...
	fism_err_tmp=fism_error[keep_dys,*]
        if keyword_set(alltags) then begin
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag1.sav'
           fism_pred_tmp_tag1=fism_pred_tag1[keep_dys,*]
           fism_err_tmp_tag1=fism_error_tag1[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag2.sav'
           fism_pred_tmp_tag2=fism_pred_tag2[keep_dys,*]
           fism_err_tmp_tag2=fism_error_tag2[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag3.sav'
           fism_pred_tmp_tag3=fism_pred_tag3[keep_dys,*]
           fism_err_tmp_tag3=fism_error_tag3[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag4.sav'
           fism_pred_tmp_tag4=fism_pred_tag4[keep_dys,*]
           fism_err_tmp_tag4=fism_error_tag4[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag5.sav'
           fism_pred_tmp_tag5=fism_pred_tag5[keep_dys,*]
           fism_err_tmp_tag5=fism_error_tag5[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag6.sav'
           fism_pred_tmp_tag6=fism_pred_tag6[keep_dys,*]
           fism_err_tmp_tag6=fism_error_tag6[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag7.sav'
           fism_pred_tmp_tag7=fism_pred_tag7[keep_dys,*]
           fism_err_tmp_tag7=fism_error_tag7[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag8.sav'
           fism_pred_tmp_tag8=fism_pred_tag8[keep_dys,*]
           fism_err_tmp_tag8=fism_error_tag8[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag9.sav'
           fism_pred_tmp_tag9=fism_pred_tag9[keep_dys,*]
           fism_err_tmp_tag9=fism_error_tag9[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag10.sav'
           fism_pred_tmp_tag10=fism_pred_tag10[keep_dys,*]
           fism_err_tmp_tag10=fism_error_tag10[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag11.sav'
           fism_pred_tmp_tag11=fism_pred_tag11[keep_dys,*]
           fism_err_tmp_tag11=fism_error_tag11[keep_dys,*]
           restore,  expand_path('$fism_results')+'/merged/FISM_daily_xuv_merged_'+version+'_tag12.sav'
           fism_pred_tmp_tag12=fism_pred_tag12[keep_dys,*]
           fism_err_tmp_tag12=fism_error_tag12[keep_dys,*]
        endif 
	day_ar_tmp=day_ar[keep_dys]
endif else begin
        restore, res_pth+'/2011/FISM_daily_2011010_xuv_'+version+'.sav' ; example to get wv
	...
	fism_err_tmp=fltarr(1,nwvs)
        if keyword_set(alltags) then begin
           ...
           fism_pred_tmp_tag12=fltarr(1,nwvs)
           fism_err_tmp_tag12=fltarr(1,nwvs)
        endif 
	day_ar_tmp=lonarr(1)
endelse
...
if keyword_set(alltags) then begin
   ...
   fism_pred_tag12=fism_pred_tmp_tag12[1:ndys-1,*]
   fism_error_tag12=fism_err_tmp_tag12[1:ndys-1,*]
endif
...
if keyword_set(strt_yr) then begin
	if keyword_set(end_yr) then begin
		if strt_yr eq end_yr then begin
			flnm=sv_pth+'/FISM_daily_xuv_merged_'+strtrim(strt_yr,2)+'_'+version
		endif else begin
			flnm=sv_pth+'/FISM_daily_xuv_merged_'+strtrim(strt_yr,2)+'_'+$
	...
	if keyword_set(end_yr) then begin
		...
		flnm=sv_pth+'/FISM_daily_xuv_merged_'+version
	endelse
endelse
...
print, 'End Time create_fism_xuv_merged_daily: ', !stime
